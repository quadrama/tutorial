...
```{r, echo=FALSE, engine='tikz', out.width='90%', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', fig.cap='Relevant classes and functions in this chaper'}
...
\node (plotqdcharacterstatistics) at (2,-3) [function] {plot.QDCharacterStatistics()};
